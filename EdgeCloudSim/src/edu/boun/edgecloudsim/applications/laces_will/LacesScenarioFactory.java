 ...
 * 
 * Description:  Laces scenario factory providing the default
...
// - Centralizes creation of all pluggable simulation components for LACES
...
public class LacesScenarioFactory implements ScenarioFactory {
	...
	LacesScenarioFactory(int _numOfMobileDevice,
	...
	public EdgeOrchestrator getEdgeOrchestrator() {
		...
		return new LacesEdgeOrchestrator(orchestratorPolicy, simScenario, bridge);
	}
	...
	public NetworkModel getNetworkModel() {
		...
		return new LacesNetworkModel(numOfMobileDevice, simScenario);
	}
	...
	public MobileDeviceManager getMobileDeviceManager() throws Exception {
		...
		return new LacesMobileDeviceManager();
	}
