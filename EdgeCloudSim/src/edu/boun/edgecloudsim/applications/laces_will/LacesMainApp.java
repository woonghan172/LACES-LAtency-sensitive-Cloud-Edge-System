...
public class LacesMainApp {
	
	public static final int EXPECTED_NUM_OF_ARGS = 5;
	public static final String APPLICATION_FOLDER = "laces_will";
	...
	public static void main(String[] args) {
		...
		GatewayServer gatewayServer = new GatewayServer(bridge);
		gatewayServer.start();
        SimLogger.printLine("Py4J Gateway Server started. Waiting for Python RL Agent...");
				...
				for(int k=0; k<SS.getSimulationScenarios().length; k++)
				{
					...
					for(int i=0; i<SS.getOrchestratorPolicies().length; i++)
					{
						...
						try
						{
							...
							ScenarioFactory lacesFactory = new LacesScenarioFactory(j,SS.getSimulationTime(), orchestratorPolicy, simScenario, bridge);
	
							// SimManager wires entities and drives the discrete-event simulation
							SimManager manager = new SimManager(lacesFactory, j, simScenario, orchestratorPolicy);
