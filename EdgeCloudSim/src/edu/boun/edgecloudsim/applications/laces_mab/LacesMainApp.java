...
public class LacesMainApp {
	...
	public static final String APPLICATION_FOLDER = "laces_mab";
				...
				for(int k=0; k<SS.getSimulationScenarios().length; k++)
				{
					...
					for(int i=0; i<SS.getOrchestratorPolicies().length; i++)
					{
						...
						try
						{
							...
							ScenarioFactory lacesFactory = new LacesScenarioFactory(j,SS.getSimulationTime(), orchestratorPolicy, simScenario);
